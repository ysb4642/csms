					...
					<div class="m-l-25 m-r--38 m-lr-0-xl">
									...
									<c:otherwise>
										<c:forEach var="goodsDto" items="${goodsList }" varStatus="i">
											<tr>
												...
												<td>
													<div class="row">
														<img src="${contextPath }/resources/bootstrap/images/item-cart-04.jpg" alt="IMG" width="100" height="100" class="m-l-100">
						...
						<div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
							...
							<div class="flex-c-m stext-101 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10">
								<button type="button" onclick="javascript:location.href='${contextPath}/admin/goods/adminGoodsAdd'">
									등록
								</button>
							</div>
						</div>
