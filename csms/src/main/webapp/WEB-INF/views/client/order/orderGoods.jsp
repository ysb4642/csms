...
<script>
	...
	$().ready(function name() {
		...
		var discountRate = ${goodsDto.discountRate};
		var price = ${goodsDto.price};
		var orderGoodsQty = ${orderGoodsQty};
		var viewPaymentAmt = (price - parseInt(price * (discountRate / 100))) * orderGoodsQty;
		var totalDeliveryPrice = ${goodsDto.deliveryPrice}
		...
		$("[name='paymentAmt']").val(viewPaymentAmt);
...
<form action="${contextPath }/order/orderGoods" method="post" name="form" onsubmit="return formValidationCheck()">
				...
				<div class="m-l-25 m-r--38 m-lr-0-xl">
					...
					<div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
						<div>
	                        ...
	                        포인트 <span id="totalPoint"><fmt:formatNumber value="${goodsDto.point * orderGoodsQty}"/>P 적립</span><br>
						</div>
							<div>
								<h5>Total <span id="viewPaymentAmt"></span></h5>
								<input type="hidden" name="paymentAmt">
							</div>							
					</div>
				</div>
			</div>
