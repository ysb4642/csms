...
<body>
	...
	<section class="section-slide">
		<div class="wrap-slick1 rs2-slick1">
			<div class="slick1">
				<div class="item-slick1 bg-overlay1" style="background-image: url(${contextPath }/resources/bootstrap/images/slide01.jpg);" data-thumb="${contextPath }/resources/bootstrap/images/thumb01.jpg" data-caption="food & snack">
					<div class="container h-full">
						<div class="flex-col-c-m h-full p-t-100 p-b-60 respon5">
							...
							<div class="layer-slick1 animated visible-false" data-appear="zoomIn" data-delay="1600">
								<a href="${contextPath }/goods/goodsList?sort=all" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn2 p-lr-15 trans-04">
									Shop Now
								</a>
							</div>
						</div>
				...
				<div class="item-slick1 bg-overlay1" style="background-image: url(${contextPath }/resources/bootstrap/images/slide02.jpg);" data-thumb="${contextPath }/resources/bootstrap/images/thumb02.jpg" data-caption="sand & beauty">
					<div class="container h-full">
						<div class="flex-col-c-m h-full p-t-100 p-b-60 respon5">
				...
				<div class="item-slick1 bg-overlay1" style="background-image: url(${contextPath }/resources/bootstrap/images/slide03.jpg);" data-thumb="${contextPath }/resources/bootstrap/images/thumb03.jpg" data-caption="cat Tower & toy">
					<div class="container h-full">
						<div class="flex-col-c-m h-full p-t-100 p-b-60 respon5">
